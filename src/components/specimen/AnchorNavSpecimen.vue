<template>
  <SpecimenPage
    ...
    description="This page showcases the AnchorNav component, a fixed-position navigation component with a flyout menu that uses SubNav for content display."
    @backToLanding="$emit('backToLanding')"
  >

    <div class="gps-specimen__section">
      <h2 class="gps-specimen__section-title">Basic AnchorNav</h2>
      <p class="gps-specimen__section-desc">The AnchorNav component provides a fixed anchor button that opens a flyout menu containing navigation links or other content.</p>
          ...
          <AnchorNav>
            <div class="gps-specimen__nav-content">
              ...
              <div class="gps-specimen__nav-links">
                <Button type="flat" size="compact">🏠 Home</Button>
                <Button type="flat" size="compact">🎮 Game</Button>
                <Button type="flat" size="compact">⚙️ Settings</Button>
                <Button type="flat" size="compact">📊 Stats</Button>
              </div>
            </div>
          </AnchorNav>
        </div>
    ...
    <div class="gps-specimen__section">
      ...
      <p class="gps-specimen__section-desc">AnchorNav can contain organized sections of navigation items using the slot content.</p>
      <div class="gps-specimen__examples">
        <div class="gps-specimen__anchor-demo">
          <AnchorNav>
            <div class="gps-specimen__nav-content">
              <div class="gps-specimen__nav-section">
                ...
                <div class="gps-specimen__nav-links">
                  <Button type="flat" size="compact">🏠 Dashboard</Button>
                  <Button type="flat" size="compact">🐹 Guinea Pigs</Button>
                  <Button type="flat" size="compact">🏠 Cage Management</Button>
                </div>
              </div>
              ...
              <div class="gps-specimen__nav-section">
                <h4>Tools</h4>
                <div class="gps-specimen__nav-links">
                  <Button type="flat" size="compact">📊 Statistics</Button>
                  <Button type="flat" size="compact">⚙️ Settings</Button>
                  <Button type="flat" size="compact">❓ Help</Button>
                </div>
              </div>
            </div>
          </AnchorNav>
    ...
    <div class="gps-specimen__section">
      ...
      <p class="gps-specimen__section-desc">AnchorNav can serve as a quick actions menu with different button types for various actions.</p>
      <div class="gps-specimen__examples">
        <div class="gps-specimen__anchor-demo">
          <AnchorNav>
            <div class="gps-specimen__nav-content">
              ...
              <div class="gps-specimen__nav-actions">
                ...
                <Button type="secondary" size="compact">📋 View Reports</Button>
                <Button type="warning" size="compact">🧹 Clean Cage</Button>
                <Button type="flat" size="compact">💾 Save Game</Button>
              </div>
            </div>
          </AnchorNav>
        </div>
    ...
    <div class="gps-specimen__section">
      ...
      <p class="gps-specimen__section-desc">The AnchorNav slot can contain any type of content, not just navigation links.</p>
      <div class="gps-specimen__examples">
        <div class="gps-specimen__anchor-demo">
          <AnchorNav>
            <div class="gps-specimen__nav-content">
              ...
              <div class="gps-specimen__nav-section">
                <h4>Quick Actions</h4>
                <div class="gps-specimen__nav-links">
                  <Button type="primary" size="compact">🍎 Feed All</Button>
                  <Button type="secondary" size="compact">🧹 Clean All</Button>
                </div>
              </div>
            </div>
          </AnchorNav>
    ...
    <div class="gps-specimen__section">
      ...
      <div class="gps-specimen__guidelines">
        ...
        <ul>
          ...
          <li><strong>Toggle Button:</strong> Uses the Button component with anchor emoji (⚓) for consistent styling</li>
...
<script setup>
import AnchorNav from '../navigation/AnchorNav.vue'
...
/* Override AnchorNav fixed positioning for specimen demonstrations */
.gps-specimen__anchor-demo .gps-anchor-nav {
  position: absolute;
...
.gps-specimen__anchor-demo .gps-anchor-nav .gps-subnav {
  position: absolute;
  top: 0;
